...
var ImageGeneratorLinuxService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ImageGeneratorLinuxService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const crypto = __importStar(require("crypto"));
let ImageGeneratorLinuxService = ImageGeneratorLinuxService_1 = class ImageGeneratorLinuxService {
    configService;
    logger = new common_1.Logger(ImageGeneratorLinuxService_1.name);
    uploadPath;
    ...
    async generateWithAlternativeMethod(html, outputPath) {
        await this.useHeadlessChromeDirectly(html, outputPath);
    }
    async useHeadlessChromeDirectly(html, outputPath) {
    ...
    getNotificationTemplate(amount, commission, customerName, serviceType, logoUrl) {
        return `
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    createFallbackUrl(billNumber, amount, commission) {
        const baseUrl = this.configService.get('APP_URL', 'http://localhost:3000');
...
exports.ImageGeneratorLinuxService = ImageGeneratorLinuxService;
exports.ImageGeneratorLinuxService = ImageGeneratorLinuxService = ImageGeneratorLinuxService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], ImageGeneratorLinuxService);
//# sourceMappingURL=image-generator-linux.service.js.map